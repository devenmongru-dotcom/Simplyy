    ...
    <div style={{ background: C.bgOff }}>
      <section
        style={{
          ...
          background: `radial-gradient(ellipse 70% 50% at 40% 0%, ${C.blueLight}, transparent 65%), ${C.bg}`
        }}
      >
        <div style={{ maxWidth: 1040, margin: "0 auto" }}>
          <div className="contact-grid">
            <Reveal>
              ...
              >
                Your first call is free. We'll review your online presence,
                identify what's costing you customers, and show you exactly
                what we'd do — no pressure.
              </p>
                ...
                >
                  ...
                  <div style={{ marginBottom: 12 }}>
                    ...
                    <input
                      ...
                      value={form.business}
                      onChange={(e) => h("business", e.target.value)}
                      onFocus={focus}
                      onBlur={blur}
                    />
                  </div>
